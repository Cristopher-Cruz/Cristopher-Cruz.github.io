function Calendarize() {
	...
	return {
		...
		// Create a full 12-month calendar in reverse order
		buildYearCalendar: function(el, year) {
			...
			months.reverse().forEach(function(a, b) { // Reverse the order of months
				var $monthNode = _this.buildMonth(a.getMonth(), year, opts); // Pass the month number as `a.getMonth()`
